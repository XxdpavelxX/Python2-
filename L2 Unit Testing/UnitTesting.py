...
Make a UnitTesting_Homework project and assign it to the Python2_Homework working set. In this project, write a 
unittest test program for the following function.
...
def title(s):
 ...
 Because this is purely an exercise it's OK to put your test code in the same file as the function and 
 just hand in a single file.
